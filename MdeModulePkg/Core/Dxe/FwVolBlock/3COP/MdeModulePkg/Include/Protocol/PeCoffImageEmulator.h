...
**/
typedef _Ptr<BOOLEAN (_Ptr<EDKII_PECOFF_IMAGE_EMULATOR_PROTOCOL>, UINT16, _Ptr<EFI_DEVICE_PATH_PROTOCOL>)> EDKII_PECOFF_IMAGE_EMULATOR_IS_IMAGE_SUPPORTED)(
...
/**
  ...
  then ASSERT().
**/
typedef _Ptr<EFI_STATUS (_Ptr<EDKII_PECOFF_IMAGE_EMULATOR_PROTOCOL>, EFI_PHYSICAL_ADDRESS, UINT64, _Ptr<EFI_STATUS (EFI_HANDLE, _Ptr<EFI_SYSTEM_TABLE>)>)> EDKII_PECOFF_IMAGE_EMULATOR_REGISTER_IMAGE)(
  IN      EDKII_PECOFF_IMAGE_EMULATOR_PROTOCOL    *This,
...
**/
typedef _Ptr<EFI_STATUS (_Ptr<EDKII_PECOFF_IMAGE_EMULATOR_PROTOCOL>, EFI_PHYSICAL_ADDRESS)> EDKII_PECOFF_IMAGE_EMULATOR_UNREGISTER_IMAGE)(
  IN  EDKII_PECOFF_IMAGE_EMULATOR_PROTOCOL    *This,
  IN  EFI_PHYSICAL_ADDRESS                    ImageBase
  );
