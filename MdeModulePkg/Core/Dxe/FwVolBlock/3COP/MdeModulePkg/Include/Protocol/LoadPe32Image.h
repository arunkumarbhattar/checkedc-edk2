...
**/
typedef _Ptr<EFI_STATUS (_Ptr<EFI_PE32_IMAGE_PROTOCOL>, EFI_HANDLE, _Ptr<EFI_DEVICE_PATH_PROTOCOL>, void *, UINTN, EFI_PHYSICAL_ADDRESS, _Ptr<UINTN>, EFI_HANDLE *, _Ptr<EFI_PHYSICAL_ADDRESS>, UINT32)> LOAD_PE_IMAGE)(
...
--*/
typedef _Ptr<EFI_STATUS (_Ptr<EFI_PE32_IMAGE_PROTOCOL>, EFI_HANDLE)> UNLOAD_PE_IMAGE)(
  IN EFI_PE32_IMAGE_PROTOCOL          *This,
