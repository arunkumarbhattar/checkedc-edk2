...
typedef struct {
  ...
  UINT64 CurrentTotalUsageByType _Checked[EfiMaxMemoryType + 2];
  UINT64 PeakTotalUsageByType _Checked[EfiMaxMemoryType + 2];
...
typedef struct {
  ...
  UINT64                          CurrentUsage;
  UINT64                          PeakUsage;
  UINT64 CurrentUsageByType _Checked[EfiMaxMemoryType + 2];
  UINT64 PeakUsageByType _Checked[EfiMaxMemoryType + 2];
...
**/
typedef _Ptr<EFI_STATUS (_Ptr<EDKII_MEMORY_PROFILE_PROTOCOL>, _Ptr<UINT64>, void *)> EDKII_MEMORY_PROFILE_GET_DATA)(
...
**/
typedef _Ptr<EFI_STATUS (_Ptr<EDKII_MEMORY_PROFILE_PROTOCOL>, _Ptr<EFI_DEVICE_PATH_PROTOCOL>, PHYSICAL_ADDRESS, UINT64, EFI_FV_FILETYPE)> EDKII_MEMORY_PROFILE_REGISTER_IMAGE)(
  IN EDKII_MEMORY_PROFILE_PROTOCOL      *This,
...
**/
typedef _Ptr<EFI_STATUS (_Ptr<EDKII_MEMORY_PROFILE_PROTOCOL>, _Ptr<EFI_DEVICE_PATH_PROTOCOL>, PHYSICAL_ADDRESS, UINT64)> EDKII_MEMORY_PROFILE_UNREGISTER_IMAGE)(
  IN EDKII_MEMORY_PROFILE_PROTOCOL      *This,
  IN EFI_DEVICE_PATH_PROTOCOL           *FilePath,
  IN PHYSICAL_ADDRESS                   ImageBase,
  IN UINT64                             ImageSize
...
**/
typedef _Ptr<EFI_STATUS (_Ptr<EDKII_MEMORY_PROFILE_PROTOCOL>, _Ptr<BOOLEAN>)> EDKII_MEMORY_PROFILE_GET_RECORDING_STATE)(
  IN EDKII_MEMORY_PROFILE_PROTOCOL      *This,
...
**/
typedef _Ptr<EFI_STATUS (_Ptr<EDKII_MEMORY_PROFILE_PROTOCOL>, BOOLEAN)> EDKII_MEMORY_PROFILE_SET_RECORDING_STATE)(
  IN EDKII_MEMORY_PROFILE_PROTOCOL      *This,
...
**/
typedef _Ptr<EFI_STATUS (_Ptr<EDKII_MEMORY_PROFILE_PROTOCOL>, PHYSICAL_ADDRESS, MEMORY_PROFILE_ACTION, EFI_MEMORY_TYPE, void *, UINTN, _Ptr<CHAR8>)> EDKII_MEMORY_PROFILE_RECORD)(
  IN EDKII_MEMORY_PROFILE_PROTOCOL      *This,
