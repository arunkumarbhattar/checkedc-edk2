...
**/
typedef _Ptr<EFI_STATUS (EFI_GCD_MEMORY_TYPE, EFI_PHYSICAL_ADDRESS, UINT64, UINT64)> EFI_ADD_MEMORY_SPACE)(
...
**/
typedef _Ptr<EFI_STATUS (EFI_GCD_ALLOCATE_TYPE, EFI_GCD_MEMORY_TYPE, UINTN, UINT64, _Ptr<EFI_PHYSICAL_ADDRESS>, EFI_HANDLE, EFI_HANDLE)> EFI_ALLOCATE_MEMORY_SPACE)(
...
**/
typedef _Ptr<EFI_STATUS (EFI_PHYSICAL_ADDRESS, UINT64)> EFI_FREE_MEMORY_SPACE)(
  IN EFI_PHYSICAL_ADDRESS  BaseAddress,
  IN UINT64                Length
  );
...
**/
typedef _Ptr<EFI_STATUS (EFI_PHYSICAL_ADDRESS, UINT64)> EFI_REMOVE_MEMORY_SPACE)(
  IN EFI_PHYSICAL_ADDRESS  BaseAddress,
  IN UINT64                Length
  );
...
**/
typedef _Ptr<EFI_STATUS (EFI_PHYSICAL_ADDRESS, _Ptr<EFI_GCD_MEMORY_SPACE_DESCRIPTOR>)> EFI_GET_MEMORY_SPACE_DESCRIPTOR)(
  IN  EFI_PHYSICAL_ADDRESS             BaseAddress,
...
/**
  ...
  @retval EFI_NOT_AVAILABLE_YET The attributes cannot be set because CPU architectural protocol is
                                not available yet.
**/
typedef _Ptr<EFI_STATUS (EFI_PHYSICAL_ADDRESS, UINT64, UINT64)> EFI_SET_MEMORY_SPACE_ATTRIBUTES)(
  IN EFI_PHYSICAL_ADDRESS         BaseAddress,
  IN UINT64                       Length,
...
**/
typedef _Ptr<EFI_STATUS (EFI_PHYSICAL_ADDRESS, UINT64, UINT64)> EFI_SET_MEMORY_SPACE_CAPABILITIES)(
  IN EFI_PHYSICAL_ADDRESS  BaseAddress,
  IN UINT64                Length,
  IN UINT64                Capabilities
  );
...
**/
typedef _Ptr<EFI_STATUS (_Ptr<UINTN>, _Ptr<_Ptr<EFI_GCD_MEMORY_SPACE_DESCRIPTOR>>)> EFI_GET_MEMORY_SPACE_MAP)(
...
**/
typedef _Ptr<EFI_STATUS (EFI_GCD_IO_TYPE, EFI_PHYSICAL_ADDRESS, UINT64)> EFI_ADD_IO_SPACE)(
...
**/
typedef _Ptr<EFI_STATUS (EFI_GCD_ALLOCATE_TYPE, EFI_GCD_IO_TYPE, UINTN, UINT64, _Ptr<EFI_PHYSICAL_ADDRESS>, EFI_HANDLE, EFI_HANDLE)> EFI_ALLOCATE_IO_SPACE)(
  IN     EFI_GCD_ALLOCATE_TYPE               GcdAllocateType,
  IN     EFI_GCD_IO_TYPE                     GcdIoType,
  IN     UINTN                               Alignment,
  IN     UINT64                              Length,
...
**/
typedef _Ptr<EFI_STATUS (EFI_PHYSICAL_ADDRESS, UINT64)> EFI_FREE_IO_SPACE)(
  IN EFI_PHYSICAL_ADDRESS  BaseAddress,
  IN UINT64                Length
  );
...
**/
typedef _Ptr<EFI_STATUS (EFI_PHYSICAL_ADDRESS, UINT64)> EFI_REMOVE_IO_SPACE)(
  IN EFI_PHYSICAL_ADDRESS  BaseAddress,
  IN UINT64                Length
  );
...
**/
typedef _Ptr<EFI_STATUS (EFI_PHYSICAL_ADDRESS, _Ptr<EFI_GCD_IO_SPACE_DESCRIPTOR>)> EFI_GET_IO_SPACE_DESCRIPTOR)(
  IN  EFI_PHYSICAL_ADDRESS         BaseAddress,
...
**/
typedef _Ptr<EFI_STATUS (_Ptr<UINTN>, _Ptr<_Ptr<EFI_GCD_IO_SPACE_DESCRIPTOR>>)> EFI_GET_IO_SPACE_MAP)(
  OUT UINTN                        *NumberOfDescriptors,
...
**/
typedef _Ptr<EFI_STATUS (void)> EFI_DISPATCH)(
  VOID
  );
...
**/
typedef _Ptr<EFI_STATUS (EFI_HANDLE, _Ptr<const EFI_GUID>)> EFI_SCHEDULE)(
...
**/
typedef _Ptr<EFI_STATUS (EFI_HANDLE, _Ptr<const EFI_GUID>)> EFI_TRUST)(
  IN EFI_HANDLE  FirmwareVolumeHandle,
  IN CONST EFI_GUID    *FileName
  );
...
**/
typedef _Ptr<EFI_STATUS (const void *, UINTN, EFI_HANDLE *)> EFI_PROCESS_FIRMWARE_VOLUME)(
