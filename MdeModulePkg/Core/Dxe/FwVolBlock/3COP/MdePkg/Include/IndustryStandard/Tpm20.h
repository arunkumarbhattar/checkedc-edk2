...
typedef struct {
  UINT16    size;
  BYTE buffer _Checked[sizeof (TPMU_HA)];
} TPM2B_DIGEST;

// Table 69 - TPM2B_DATA Structure
typedef struct {
  UINT16    size;
  BYTE buffer _Checked[sizeof (TPMT_HA)];
} TPM2B_DATA;
...
typedef struct {
  UINT16    size;
  BYTE buffer _Checked[1024];
} TPM2B_EVENT;

// Table 74 - TPM2B_MAX_BUFFER Structure
typedef struct {
  UINT16    size;
  BYTE buffer _Checked[MAX_DIGEST_BUFFER];
} TPM2B_MAX_BUFFER;

// Table 75 - TPM2B_MAX_NV_BUFFER Structure
typedef struct {
  UINT16    size;
  BYTE buffer _Checked[MAX_NV_INDEX_SIZE];
} TPM2B_MAX_NV_BUFFER;

// Table 76 - TPM2B_TIMEOUT Structure
typedef struct {
  UINT16    size;
  BYTE buffer _Checked[sizeof (UINT64)];
} TPM2B_TIMEOUT;

// Table 77 -- TPM2B_IV Structure <I/O>
typedef struct {
  UINT16    size;
  BYTE buffer _Checked[MAX_SYM_BLOCK_SIZE];
} TPM2B_IV;
...
typedef struct {
  UINT16    size;
  BYTE name _Checked[sizeof (TPMU_NAME)];
} TPM2B_NAME;

// Table 80 - TPMS_PCR_SELECT Structure
typedef struct {
  UINT8    sizeofSelect;
  BYTE pcrSelect _Checked[PCR_SELECT_MAX];
} TPMS_PCR_SELECT;
...
typedef struct {
  UINT32    count;
  TPM_CC commandCodes _Checked[MAX_CAP_CC];
} TPML_CC;

// Table 92 - TPML_CCA Structure
typedef struct {
  UINT32     count;
  TPMA_CC commandAttributes _Checked[MAX_CAP_CC];
} TPML_CCA;

// Table 93 - TPML_ALG Structure
typedef struct {
  UINT32        count;
  TPM_ALG_ID algorithms _Checked[MAX_ALG_LIST_SIZE];
} TPML_ALG;

// Table 94 - TPML_HANDLE Structure
typedef struct {
  UINT32        count;
  TPM_HANDLE handle _Checked[MAX_CAP_HANDLES];
} TPML_HANDLE;

// Table 95 - TPML_DIGEST Structure
typedef struct {
  UINT32          count;
  TPM2B_DIGEST digests _Checked[8];
} TPML_DIGEST;

// Table 96 -- TPML_DIGEST_VALUES Structure <I/O>
typedef struct {
  UINT32     count;
  TPMT_HA digests _Checked[HASH_COUNT];
} TPML_DIGEST_VALUES;

// Table 97 - TPM2B_DIGEST_VALUES Structure
typedef struct {
  UINT16    size;
  BYTE buffer _Checked[sizeof (TPML_DIGEST_VALUES)];
} TPM2B_DIGEST_VALUES;

// Table 98 - TPML_PCR_SELECTION Structure
typedef struct {
  UINT32                count;
  TPMS_PCR_SELECTION pcrSelections _Checked[HASH_COUNT];
} TPML_PCR_SELECTION;

// Table 99 - TPML_ALG_PROPERTY Structure
typedef struct {
  UINT32               count;
  TPMS_ALG_PROPERTY algProperties _Checked[MAX_CAP_ALGS];
} TPML_ALG_PROPERTY;

// Table 100 - TPML_TAGGED_TPM_PROPERTY Structure
typedef struct {
  UINT32                  count;
  TPMS_TAGGED_PROPERTY tpmProperty _Checked[MAX_TPM_PROPERTIES];
} TPML_TAGGED_TPM_PROPERTY;

// Table 101 - TPML_TAGGED_PCR_PROPERTY Structure
typedef struct {
  UINT32                    count;
  TPMS_TAGGED_PCR_SELECT pcrProperty _Checked[MAX_PCR_PROPERTIES];
} TPML_TAGGED_PCR_PROPERTY;

// Table 102 - TPML_ECC_CURVE Structure
typedef struct {
  UINT32           count;
  TPM_ECC_CURVE eccCurves _Checked[MAX_ECC_CURVES];
} TPML_ECC_CURVE;
...
typedef struct {
  UINT16    size;
  BYTE attestationData _Checked[sizeof (TPMS_ATTEST)];
} TPM2B_ATTEST;
...
typedef struct {
  UINT16    size;
  BYTE buffer _Checked[MAX_SYM_KEY_BYTES];
} TPM2B_SYM_KEY;
...
typedef struct {
  UINT16    size;
  BYTE buffer _Checked[MAX_SYM_DATA];
...
typedef struct {
  UINT16    size;
  BYTE buffer _Checked[MAX_RSA_KEY_BYTES];
...
typedef struct {
  UINT16    size;
  BYTE buffer _Checked[MAX_RSA_KEY_BYTES/2];
} TPM2B_PRIVATE_KEY_RSA;

// Table 161 - TPM2B_ECC_PARAMETER Structure
typedef struct {
  UINT16    size;
  BYTE buffer _Checked[MAX_ECC_KEY_BYTES];
} TPM2B_ECC_PARAMETER;
...
typedef struct {
  UINT16    size;
  BYTE secret _Checked[sizeof (TPMU_ENCRYPTED_SECRET)];
...
typedef struct {
  UINT16    size;
  BYTE buffer _Checked[PRIVATE_VENDOR_SPECIFIC_BYTES];
...
typedef struct {
  UINT16    size;
  BYTE buffer _Checked[sizeof (_PRIVATE)];
} TPM2B_PRIVATE;
...
typedef struct {
  UINT16    size;
  BYTE credential _Checked[sizeof (_ID_OBJECT)];
} TPM2B_ID_OBJECT;
...
typedef struct {
  UINT16    size;
  BYTE buffer _Checked[MAX_CONTEXT_SIZE];
...
typedef struct {
  UINT16    size;
  BYTE buffer _Checked[sizeof (TPMS_CONTEXT_DATA)];
} TPM2B_CONTEXT_DATA;
