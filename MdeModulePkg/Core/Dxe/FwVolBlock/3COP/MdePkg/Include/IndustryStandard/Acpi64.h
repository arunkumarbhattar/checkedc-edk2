...
typedef struct {
  ...
  UINT32    AcpiId;
  UINT64    WakeupVector;
  UINT8 ReservedForOs _Checked[2032];
  UINT8 ReservedForFirmware _Checked[2048];
...
typedef struct {
  ...
  UINT8 Reserved_5 _Checked[3];
  UINT32    Capabilities;
  UINT8 Reserved_12 _Checked[4];
