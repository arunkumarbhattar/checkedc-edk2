...
**/
typedef _Ptr<EFI_STATUS (_Ptr<EFI_TCG_PROTOCOL>, _Ptr<TCG_EFI_BOOT_SERVICE_CAPABILITY>, _Ptr<UINT32>, _Ptr<EFI_PHYSICAL_ADDRESS>, _Ptr<EFI_PHYSICAL_ADDRESS>)> EFI_TCG_STATUS_CHECK)(
...
**/
typedef _Ptr<EFI_STATUS (_Ptr<EFI_TCG_PROTOCOL>, _Ptr<UINT8>, UINT64, TCG_ALGORITHM_ID, _Ptr<UINT64>, _Ptr<_Ptr<UINT8>>)> EFI_TCG_HASH_ALL)(
  IN      EFI_TCG_PROTOCOL          *This,
  IN      UINT8                     *HashData,
...
**/
typedef _Ptr<EFI_STATUS (_Ptr<EFI_TCG_PROTOCOL>, _Ptr<TCG_PCR_EVENT>, _Ptr<UINT32>, UINT32)> EFI_TCG_LOG_EVENT)(
  IN      EFI_TCG_PROTOCOL          *This,
...
**/
typedef _Ptr<EFI_STATUS (_Ptr<EFI_TCG_PROTOCOL>, UINT32, _Ptr<UINT8>, UINT32, _Ptr<UINT8>)> EFI_TCG_PASS_THROUGH_TO_TPM)(
  IN      EFI_TCG_PROTOCOL          *This,
...
**/
typedef _Ptr<EFI_STATUS (_Ptr<EFI_TCG_PROTOCOL>, EFI_PHYSICAL_ADDRESS, UINT64, TCG_ALGORITHM_ID, _Ptr<TCG_PCR_EVENT>, _Ptr<UINT32>, _Ptr<EFI_PHYSICAL_ADDRESS>)> EFI_TCG_HASH_LOG_EXTEND_EVENT)(
  IN      EFI_TCG_PROTOCOL          *This,
