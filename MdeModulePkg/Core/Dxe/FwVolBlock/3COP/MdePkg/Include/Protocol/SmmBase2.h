...
**/
typedef _Ptr<EFI_STATUS (_Ptr<const EFI_SMM_BASE2_PROTOCOL>, _Ptr<BOOLEAN>)> EFI_SMM_INSIDE_OUT2)(
...
**/
typedef _Ptr<EFI_STATUS (_Ptr<const EFI_SMM_BASE2_PROTOCOL>, _Ptr<_Ptr<EFI_SMM_SYSTEM_TABLE2>>)> EFI_SMM_GET_SMST_LOCATION2)(
  IN CONST EFI_SMM_BASE2_PROTOCOL  *This,
