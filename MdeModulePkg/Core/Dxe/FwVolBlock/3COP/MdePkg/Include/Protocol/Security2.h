...
**/
typedef _Ptr<EFI_STATUS (_Ptr<const EFI_SECURITY2_ARCH_PROTOCOL>, _Ptr<const EFI_DEVICE_PATH_PROTOCOL>, void *, UINTN, BOOLEAN)> EFI_SECURITY2_FILE_AUTHENTICATION)(
