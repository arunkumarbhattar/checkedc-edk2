...
**/
typedef _Ptr<EFI_STATUS (_Ptr<EFI_DECOMPRESS_PROTOCOL>, void *, UINT32, _Ptr<UINT32>, _Ptr<UINT32>)> EFI_DECOMPRESS_GET_INFO)(
...
**/
typedef _Ptr<EFI_STATUS (_Ptr<EFI_DECOMPRESS_PROTOCOL>, void *, UINT32, void *, UINT32, void *, UINT32)> EFI_DECOMPRESS_DECOMPRESS)(
  IN EFI_DECOMPRESS_PROTOCOL              *This,
  IN     VOID                             *Source,
  IN     UINT32                           SourceSize,
