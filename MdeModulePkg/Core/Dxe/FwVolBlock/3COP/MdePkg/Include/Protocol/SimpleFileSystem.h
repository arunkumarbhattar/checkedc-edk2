...
typedef _Ptr<struct _EFI_FILE_PROTOCOL> EFI_FILE_HANDLE;
...
**/
typedef _Ptr<EFI_STATUS (_Ptr<EFI_SIMPLE_FILE_SYSTEM_PROTOCOL>, _Ptr<_Ptr<EFI_FILE_PROTOCOL>>)> EFI_SIMPLE_FILE_SYSTEM_PROTOCOL_OPEN_VOLUME)(
...
**/
typedef _Ptr<EFI_STATUS (_Ptr<EFI_FILE_PROTOCOL>, _Ptr<_Ptr<EFI_FILE_PROTOCOL>>, _Ptr<CHAR16>, UINT64, UINT64)> EFI_FILE_OPEN)(
...
**/
typedef _Ptr<EFI_STATUS (_Ptr<EFI_FILE_PROTOCOL>)> EFI_FILE_CLOSE)(
  IN EFI_FILE_PROTOCOL  *This
  );
...
**/
typedef _Ptr<EFI_STATUS (_Ptr<EFI_FILE_PROTOCOL>)> EFI_FILE_DELETE)(
  IN EFI_FILE_PROTOCOL  *This
  );
...
**/
typedef _Ptr<EFI_STATUS (_Ptr<EFI_FILE_PROTOCOL>, _Ptr<UINTN>, void *)> EFI_FILE_READ)(
  IN EFI_FILE_PROTOCOL        *This,
...
**/
typedef _Ptr<EFI_STATUS (_Ptr<EFI_FILE_PROTOCOL>, _Ptr<UINTN>, void *)> EFI_FILE_WRITE)(
  IN EFI_FILE_PROTOCOL        *This,
  IN OUT UINTN                *BufferSize,
  IN VOID                     *Buffer
  );
...
**/
typedef _Ptr<EFI_STATUS (_Ptr<EFI_FILE_PROTOCOL>, UINT64)> EFI_FILE_SET_POSITION)(
  IN EFI_FILE_PROTOCOL        *This,
  IN UINT64                   Position
  );
...
**/
typedef _Ptr<EFI_STATUS (_Ptr<EFI_FILE_PROTOCOL>, _Ptr<UINT64>)> EFI_FILE_GET_POSITION)(
  IN EFI_FILE_PROTOCOL        *This,
  OUT UINT64                  *Position
  );
...
/**
  ...
  @retval EFI_BUFFER_TOO_SMALL The BufferSize is too small to read the current directory entry.
                               ...
                               the request.
**/
typedef _Ptr<EFI_STATUS (_Ptr<EFI_FILE_PROTOCOL>, _Ptr<EFI_GUID>, _Ptr<UINTN>, void *)> EFI_FILE_GET_INFO)(
  IN EFI_FILE_PROTOCOL        *This,
...
**/
typedef _Ptr<EFI_STATUS (_Ptr<EFI_FILE_PROTOCOL>, _Ptr<EFI_GUID>, UINTN, void *)> EFI_FILE_SET_INFO)(
  IN EFI_FILE_PROTOCOL        *This,
  IN EFI_GUID                 *InformationType,
  IN UINTN                    BufferSize,
  IN VOID                     *Buffer
...
**/
typedef _Ptr<EFI_STATUS (_Ptr<EFI_FILE_PROTOCOL>)> EFI_FILE_FLUSH)(
  IN EFI_FILE_PROTOCOL  *This
  );
...
**/
typedef _Ptr<EFI_STATUS (_Ptr<EFI_FILE_PROTOCOL>, _Ptr<_Ptr<EFI_FILE_PROTOCOL>>, _Ptr<CHAR16>, UINT64, UINT64, _Ptr<EFI_FILE_IO_TOKEN>)> EFI_FILE_OPEN_EX)(
  IN EFI_FILE_PROTOCOL        *This,
  OUT EFI_FILE_PROTOCOL       **NewHandle,
  IN CHAR16                   *FileName,
  IN UINT64                   OpenMode,
...
**/
typedef _Ptr<EFI_STATUS (_Ptr<EFI_FILE_PROTOCOL>, _Ptr<EFI_FILE_IO_TOKEN>)> EFI_FILE_READ_EX)(
  IN EFI_FILE_PROTOCOL        *This,
  IN OUT EFI_FILE_IO_TOKEN    *Token
  );
...
/**
  ...
  @retval EFI_OUT_OF_RESOURCES Unable to queue the request due to lack of resources.
**/
typedef _Ptr<EFI_STATUS (_Ptr<EFI_FILE_PROTOCOL>, _Ptr<EFI_FILE_IO_TOKEN>)> EFI_FILE_WRITE_EX)(
  IN EFI_FILE_PROTOCOL        *This,
  IN OUT EFI_FILE_IO_TOKEN    *Token
  );
...
**/
typedef _Ptr<EFI_STATUS (_Ptr<EFI_FILE_PROTOCOL>, _Ptr<EFI_FILE_IO_TOKEN>)> EFI_FILE_FLUSH_EX)(
  IN EFI_FILE_PROTOCOL        *This,
  IN OUT EFI_FILE_IO_TOKEN    *Token
  );
