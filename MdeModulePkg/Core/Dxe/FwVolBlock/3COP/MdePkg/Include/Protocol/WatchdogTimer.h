...
**/
typedef _Ptr<void (UINT64)> EFI_WATCHDOG_TIMER_NOTIFY)(
  IN UINT64  Time
  );
...
**/
typedef _Ptr<EFI_STATUS (_Ptr<EFI_WATCHDOG_TIMER_ARCH_PROTOCOL>, _Ptr<void (UINT64)>)> EFI_WATCHDOG_TIMER_REGISTER_HANDLER)(
...
**/
typedef _Ptr<EFI_STATUS (_Ptr<EFI_WATCHDOG_TIMER_ARCH_PROTOCOL>, UINT64)> EFI_WATCHDOG_TIMER_SET_TIMER_PERIOD)(
  IN EFI_WATCHDOG_TIMER_ARCH_PROTOCOL  *This,
...
**/
typedef _Ptr<EFI_STATUS (_Ptr<EFI_WATCHDOG_TIMER_ARCH_PROTOCOL>, _Ptr<UINT64>)> EFI_WATCHDOG_TIMER_GET_TIMER_PERIOD)(
  IN  EFI_WATCHDOG_TIMER_ARCH_PROTOCOL  *This,
