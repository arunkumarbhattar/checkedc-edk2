...
**/
typedef _Ptr<EFI_STATUS (_Ptr<EFI_DRIVER_CONFIGURATION_PROTOCOL>, EFI_HANDLE, EFI_HANDLE, _Ptr<CHAR8>, _Ptr<EFI_DRIVER_CONFIGURATION_ACTION_REQUIRED>)> EFI_DRIVER_CONFIGURATION_SET_OPTIONS)(
...
**/
typedef _Ptr<EFI_STATUS (_Ptr<EFI_DRIVER_CONFIGURATION_PROTOCOL>, EFI_HANDLE, EFI_HANDLE)> EFI_DRIVER_CONFIGURATION_OPTIONS_VALID)(
  IN EFI_DRIVER_CONFIGURATION_PROTOCOL                        *This,
  IN  EFI_HANDLE                                              ControllerHandle,
  IN  EFI_HANDLE                                              ChildHandle  OPTIONAL
  );
...
**/
typedef _Ptr<EFI_STATUS (_Ptr<EFI_DRIVER_CONFIGURATION_PROTOCOL>, EFI_HANDLE, EFI_HANDLE, UINT32, _Ptr<EFI_DRIVER_CONFIGURATION_ACTION_REQUIRED>)> EFI_DRIVER_CONFIGURATION_FORCE_DEFAULTS)(
  IN EFI_DRIVER_CONFIGURATION_PROTOCOL                        *This,
  IN  EFI_HANDLE                                              ControllerHandle,
  IN  EFI_HANDLE                                              ChildHandle  OPTIONAL,
