...
**/
typedef _Ptr<EFI_STATUS (_Ptr<const EFI_MM_BASE_PROTOCOL>, _Ptr<BOOLEAN>)> EFI_MM_INSIDE_OUT)(
...
**/
typedef _Ptr<EFI_STATUS (_Ptr<const EFI_MM_BASE_PROTOCOL>, _Ptr<_Ptr<EFI_MM_SYSTEM_TABLE>>)> EFI_MM_GET_MMST_LOCATION)(
  IN CONST EFI_MM_BASE_PROTOCOL  *This,
