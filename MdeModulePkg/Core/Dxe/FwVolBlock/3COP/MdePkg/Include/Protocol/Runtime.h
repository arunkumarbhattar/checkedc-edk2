...
struct _EFI_RUNTIME_ARCH_PROTOCOL {
  ...
  _Ptr<EFI_MEMORY_DESCRIPTOR> MemoryMapPhysical;     ///< Pointer to a runtime buffer that contains a copy of
                                                   ///< the memory map returned via GetMemoryMap().
  _Ptr<EFI_MEMORY_DESCRIPTOR> MemoryMapVirtual;      ///< Pointer to MemoryMapPhysical that is updated to virtual mode after SetVirtualAddressMap().
