...
**/
typedef _Ptr<EFI_STATUS (_Ptr<EFI_GRAPHICS_OUTPUT_PROTOCOL>, UINT32, _Ptr<UINTN>, _Ptr<_Ptr<EFI_GRAPHICS_OUTPUT_MODE_INFORMATION>>)> EFI_GRAPHICS_OUTPUT_PROTOCOL_QUERY_MODE)(
...
**/
typedef _Ptr<EFI_STATUS (_Ptr<EFI_GRAPHICS_OUTPUT_PROTOCOL>, UINT32)> EFI_GRAPHICS_OUTPUT_PROTOCOL_SET_MODE)(
  IN  EFI_GRAPHICS_OUTPUT_PROTOCOL *This,
  IN  UINT32                       ModeNumber
  );
...
**/
typedef _Ptr<EFI_STATUS (_Ptr<EFI_GRAPHICS_OUTPUT_PROTOCOL>, _Ptr<EFI_GRAPHICS_OUTPUT_BLT_PIXEL>, EFI_GRAPHICS_OUTPUT_BLT_OPERATION, UINTN, UINTN, UINTN, UINTN, UINTN, UINTN, UINTN)> EFI_GRAPHICS_OUTPUT_PROTOCOL_BLT)(
  IN  EFI_GRAPHICS_OUTPUT_PROTOCOL            *This,
...
typedef struct {
  ...
  ///
  _Ptr<EFI_GRAPHICS_OUTPUT_MODE_INFORMATION> Info;
  ///
...
struct _EFI_GRAPHICS_OUTPUT_PROTOCOL {
  ...
  ///
  _Ptr<EFI_GRAPHICS_OUTPUT_PROTOCOL_MODE> Mode;
};
