...
**/
typedef _Ptr<EFI_STATUS (_Ptr<EFI_COMPONENT_NAME_PROTOCOL>, _Ptr<CHAR8>, _Ptr<_Ptr<CHAR16>>)> EFI_COMPONENT_NAME_GET_DRIVER_NAME)(
...
**/
typedef _Ptr<EFI_STATUS (_Ptr<EFI_COMPONENT_NAME_PROTOCOL>, EFI_HANDLE, EFI_HANDLE, _Ptr<CHAR8>, _Ptr<_Ptr<CHAR16>>)> EFI_COMPONENT_NAME_GET_CONTROLLER_NAME)(
  IN EFI_COMPONENT_NAME_PROTOCOL                              *This,
