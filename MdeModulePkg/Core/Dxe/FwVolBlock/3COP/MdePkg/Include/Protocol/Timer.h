...
**/
typedef _Ptr<void (UINT64)> EFI_TIMER_NOTIFY)(
  IN UINT64  Time
  );
...
**/
typedef _Ptr<EFI_STATUS (_Ptr<EFI_TIMER_ARCH_PROTOCOL>, _Ptr<void (UINT64)>)> EFI_TIMER_REGISTER_HANDLER)(
...
**/
typedef _Ptr<EFI_STATUS (_Ptr<EFI_TIMER_ARCH_PROTOCOL>, UINT64)> EFI_TIMER_SET_TIMER_PERIOD)(
  IN EFI_TIMER_ARCH_PROTOCOL    *This,
...
**/
typedef _Ptr<EFI_STATUS (_Ptr<EFI_TIMER_ARCH_PROTOCOL>, _Ptr<UINT64>)> EFI_TIMER_GET_TIMER_PERIOD)(
  IN EFI_TIMER_ARCH_PROTOCOL      *This,
...
**/
typedef _Ptr<EFI_STATUS (_Ptr<EFI_TIMER_ARCH_PROTOCOL>)> EFI_TIMER_GENERATE_SOFT_INTERRUPT)(
  IN EFI_TIMER_ARCH_PROTOCOL    *This
  );
