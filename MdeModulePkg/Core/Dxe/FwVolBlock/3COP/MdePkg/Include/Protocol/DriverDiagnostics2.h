...
**/
typedef _Ptr<EFI_STATUS (_Ptr<EFI_DRIVER_DIAGNOSTICS2_PROTOCOL>, EFI_HANDLE, EFI_HANDLE, EFI_DRIVER_DIAGNOSTIC_TYPE, _Ptr<CHAR8>, _Ptr<_Ptr<EFI_GUID>>, _Ptr<UINTN>, _Ptr<_Ptr<CHAR16>>)> EFI_DRIVER_DIAGNOSTICS2_RUN_DIAGNOSTICS)(
