...
**/
typedef _Ptr<EFI_STATUS (_Ptr<const EFI_FIRMWARE_VOLUME2_PROTOCOL>, _Ptr<EFI_FV_ATTRIBUTES>)> EFI_FV_GET_ATTRIBUTES)(
...
**/
typedef _Ptr<EFI_STATUS (_Ptr<const EFI_FIRMWARE_VOLUME2_PROTOCOL>, _Ptr<EFI_FV_ATTRIBUTES>)> EFI_FV_SET_ATTRIBUTES)(
  IN CONST  EFI_FIRMWARE_VOLUME2_PROTOCOL *This,
...
**/
typedef _Ptr<EFI_STATUS (_Ptr<const EFI_FIRMWARE_VOLUME2_PROTOCOL>, _Ptr<const EFI_GUID>, void **, _Ptr<UINTN>, _Ptr<EFI_FV_FILETYPE>, _Ptr<EFI_FV_FILE_ATTRIBUTES>, _Ptr<UINT32>)> EFI_FV_READ_FILE)(
  IN CONST  EFI_FIRMWARE_VOLUME2_PROTOCOL *This,
...
**/
typedef _Ptr<EFI_STATUS (_Ptr<const EFI_FIRMWARE_VOLUME2_PROTOCOL>, _Ptr<const EFI_GUID>, EFI_SECTION_TYPE, UINTN, void **, _Ptr<UINTN>, _Ptr<UINT32>)> EFI_FV_READ_SECTION)(
  IN CONST  EFI_FIRMWARE_VOLUME2_PROTOCOL *This,
  IN CONST  EFI_GUID                      *NameGuid,
...
**/
typedef _Ptr<EFI_STATUS (_Ptr<const EFI_FIRMWARE_VOLUME2_PROTOCOL>, UINT32, EFI_FV_WRITE_POLICY, _Ptr<EFI_FV_WRITE_FILE_DATA>)> EFI_FV_WRITE_FILE)(
  IN CONST  EFI_FIRMWARE_VOLUME2_PROTOCOL *This,
...
**/
typedef _Ptr<EFI_STATUS (_Ptr<const EFI_FIRMWARE_VOLUME2_PROTOCOL>, void *, _Ptr<EFI_FV_FILETYPE>, _Ptr<EFI_GUID>, _Ptr<EFI_FV_FILE_ATTRIBUTES>, _Ptr<UINTN>)> EFI_FV_GET_NEXT_FILE)(
  IN CONST  EFI_FIRMWARE_VOLUME2_PROTOCOL *This,
  IN OUT    VOID                          *Key,
...
**/
typedef _Ptr<EFI_STATUS (_Ptr<const EFI_FIRMWARE_VOLUME2_PROTOCOL>, _Ptr<const EFI_GUID>, _Ptr<UINTN>, void *)> EFI_FV_GET_INFO)(
  IN CONST  EFI_FIRMWARE_VOLUME2_PROTOCOL *This,
...
**/
typedef _Ptr<EFI_STATUS (_Ptr<const EFI_FIRMWARE_VOLUME2_PROTOCOL>, _Ptr<const EFI_GUID>, UINTN, const void *)> EFI_FV_SET_INFO)(
  IN CONST  EFI_FIRMWARE_VOLUME2_PROTOCOL *This,
  IN CONST  EFI_GUID                      *InformationType,
  IN        UINTN                         BufferSize,
