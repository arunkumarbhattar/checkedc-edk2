...
**/
typedef _Ptr<EFI_STATUS (_Ptr<EFI_PLATFORM_DRIVER_OVERRIDE_PROTOCOL>, EFI_HANDLE, EFI_HANDLE *)> EFI_PLATFORM_DRIVER_OVERRIDE_GET_DRIVER)(
...
**/
typedef _Ptr<EFI_STATUS (_Ptr<EFI_PLATFORM_DRIVER_OVERRIDE_PROTOCOL>, EFI_HANDLE, _Ptr<_Ptr<EFI_DEVICE_PATH_PROTOCOL>>)> EFI_PLATFORM_DRIVER_OVERRIDE_GET_DRIVER_PATH)(
  IN EFI_PLATFORM_DRIVER_OVERRIDE_PROTOCOL              *This,
  IN     EFI_HANDLE                                     ControllerHandle,
...
**/
typedef _Ptr<EFI_STATUS (_Ptr<EFI_PLATFORM_DRIVER_OVERRIDE_PROTOCOL>, EFI_HANDLE, _Ptr<EFI_DEVICE_PATH_PROTOCOL>, EFI_HANDLE)> EFI_PLATFORM_DRIVER_OVERRIDE_DRIVER_LOADED)(
  IN EFI_PLATFORM_DRIVER_OVERRIDE_PROTOCOL          *This,
  IN EFI_HANDLE                                     ControllerHandle,
